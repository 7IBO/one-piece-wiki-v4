...
export function FirstRunBanner(): JSX.Element | null {
  ...
  return (
    <div className='border-b border-line bg-surface'>
      <div className='mx-auto flex w-full max-w-[1100px] flex-wrap items-center gap-x-4 gap-y-1.5 px-4 py-2.5 text-sm sm:px-6'>
        ...
        <button
          ...
          className='py-1 text-xs font-medium text-muted underline decoration-line-strong underline-offset-2 transition-colors duration-150 hover:text-fg'
        >
