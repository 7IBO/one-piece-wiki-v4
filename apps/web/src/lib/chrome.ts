...
const STRINGS = {
  ...
  progressCancel: { en: 'Cancel', fr: 'Annuler' },
  progressWhere: { en: 'Where are you?', fr: 'Où en es-tu ?' },
  progressLastArc: {
    en: 'Which arc did you finish last?',
    fr: 'Quel est le dernier arc que tu as terminé ?',
  },
  progressWithinArc: { en: 'Where in {arc}?', fr: 'Où dans {arc} ?' },
  progressEditable: {
    en: 'Changeable at any time from the header.',
    fr: 'Modifiable à tout moment depuis l’en-tête.',
  },
  progressAxisManga: { en: 'Manga', fr: 'Manga' },
  progressAxisAnime: { en: 'Anime', fr: 'Anime' },
  progressNoScale: {
    en: 'No arc carries a range on this axis yet — set the number directly.',
    fr: 'Aucun arc ne porte encore d’intervalle sur cet axe — règle le numéro directement.',
  },
  progressExact: { en: 'Exact number', fr: 'Numéro exact' },
  progressStarting: { en: 'Just starting', fr: 'Je débute' },
  progressUpToDate: { en: 'Fully caught up', fr: 'Je suis à jour' },
  progressLoading: { en: 'Loading the arcs…', fr: 'Chargement des arcs…' },
